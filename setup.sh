...
**Purpose**: Patient portal interface
**Features**:
...
**Purpose**: Hospital management interface
**Features**:
...
3. **Update CORS** in server.js for production domain
...
2. All HTML files (frontend)
3. package.json (dependencies)
4. .env (configuration) - Store securely!
5. MongoDB database (use mongodump)
